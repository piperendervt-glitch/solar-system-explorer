...
| 11-4 | 照明（太陽光の差し込み・補助光） | 未着手 |
| 11-5 | 有料コックピットの判断ゲート（**購入前に止まる**） | 未着手 |
| 11-6 | 有料コックピットへの差し替え（**任意**） | 未着手 |
...
| 数値 | `_AtmosphereStrength` 0〜10（0.25 刻み）/ `_CloudOpacity` 0〜2（0.05）/ フレア基準強度 0〜2（0.05）/ 微振動の振幅 0〜5e-3（2.5e-4）/ 画面の発光強度 0〜2（0.05） |
