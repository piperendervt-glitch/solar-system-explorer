...
namespace SolarSystem.Tests.EditMode
{
    ...
    public sealed class DebugPanelLayoutTests
    {
        ...
        public void 項目数は52件()
        {
            ...
            Assert.That(RealItemCount(), Is.EqualTo(52));
        }

        [Test]
        public void フルHDのフォントは11()
        {
            ...
            //   フォント 12 (行高 18): (9 + 52) * 18 + 16 = 1114 > 1056  入らない
            //   フォント 11 (行高 17): (9 + 52) * 17 + 16 = 1053 <= 1056 入る
            // **期待値を書き換えたのは意図した変更。**
            ...
            Assert.That(l.FontSize, Is.EqualTo(11), "フォントの段が想定と違う");
