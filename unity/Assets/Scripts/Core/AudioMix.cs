...
namespace SolarSystem.Core
{
    ...
    public static class AudioMix
    {
        ...
        /// 単発（ドッキング / 出港 / UI / 警告）。
        ///
        /// **0.70 から 0.25 へ下げた (Step 10-4)。**
        /// 0.70 だと素材のピーク (約 0.9) と合わせて 0.63 になり、
        /// エンジン全開の 0.10 × 0.89 ≒ 0.089 に対して**約 7 倍**だった。
        /// 単発は「気付かせる」音なので環境音より大きくてよいが、7 倍は過剰。
        /// 0.25 はエンジン全開の約 2.5 倍。
        ///
        /// **暫定値。実機で耳で決め直す。**
        /// </summary>
        public const double SfxVolume = 0.25;
