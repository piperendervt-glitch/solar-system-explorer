...
namespace SolarSystem.Core
{
    ...
    public sealed class DebugPanelModel
    {
        ...
        /// **既定 2.0 で確定 (Step 13 クローズ)。** 13-5 の誘導灯と合わせて決める
        /// 予定だったが 13-5 は実施しない。振る口はそのまま残す。
        /// </summary>
        ...
        // 13-4（航法灯）と 13-5（誘導灯）で項目が増える見込みだったので先に手を打った。
        // **その 2 ステップは実施しないことになった**が、分類そのものは残す
        // （53 項目を 1 画面に詰めるとフォント 10 まで落ちるのは変わらないため）。
        //
