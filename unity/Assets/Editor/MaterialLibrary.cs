...
namespace SolarSystem.Editor
{
    ...
    public static class MaterialLibrary
    {
        ...
        ///
        /// 1.0 では縁の絶対的な青成分が中心 (明るい海) を下回っていた
        /// (実測: 縁 B=88.4 / 中心 B=117.2)。5.0 で 縁 B=132.0 / 中心 B=117.2。
        ///
        /// **画素テストは絶対値ではなく相対成分で判定している。**
        /// 「縁 3 画素幅の青成分 > 中心の青成分」という比較は、中心が明るい海だと
        /// 大気の強さと無関係に中心が勝ちうる。値そのものの妥当性は目視で決めた。
        /// </summary>
